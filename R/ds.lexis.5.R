...
#' ds.ls() #to confirm expanded dataframe created
#' }
ds.lexis.5<-function(data=NULL, intervalWidth=NULL, idCol=NULL, entryCol=NULL, exitCol=NULL, statusCol=NULL, variables=NULL, newobj=NULL, datasources=NULL){
...
#SOURCE. THE MAXIMUM I EACH SOURCE IS MASKED BY A RANDOM POSITIVE INCREMENT
  calltext1 <- call("lexisDS1.5", exitCol)
...
#FOLLOW-UP TIME BREAKS IN EACH STUDY (ALL THE SAME)
  ...
  calltext2 <- call("lexisDS2.5", data, intervalWidth, maxmaxtime, idCol, entryCol, exitCol, statusCol, variables)
